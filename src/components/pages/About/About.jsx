    ...
    <div className='about'>
      ...
      <h1 className='title'>About Me</h1>
        ...
        <div className='img-container'>
          ...
          <button className='resume-btn' ><a href="https://drive.google.com/file/d/1c4iWG3huS7DZeGDsXxedDn1sW_UAV95i/view?usp=sharing" target='_blank' rel='noreferrer' className='resume-btn'>Resume</a></button>
